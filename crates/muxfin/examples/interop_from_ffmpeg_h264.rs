...
use muxfin::codec::common::AnnexBNalIter;
use muxfin::codec::h264::{annexb_to_avcc, extract_avc_config, is_h264_keyframe};
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    // 2) muxfin fragmented MP4, concatenated init+segment so ffprobe can open it.
