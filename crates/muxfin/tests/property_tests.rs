//! Property-Based Tests for Muxfin
//!
...
// Import the muxfin crate
use muxfin::api::{AacProfile, AudioCodec, MuxerBuilder, VideoCodec};
use muxfin::invariant_ppt::{clear_invariant_log, contract_test};
...
mod contract_tests {
    ...
    fn contract_av1_config_extraction() {
        ...
        let _ = muxfin::codec::av1::extract_av1_config(&av1_data);
    ...
    fn contract_h264_config_extraction() {
        ...
        let _ = muxfin::codec::h264::extract_avc_config(&h264_data);
    ...
    fn contract_vp9_config_extraction() {
        ...
        let _ = muxfin::codec::vp9::extract_vp9_config(&vp9_data);
    ...
    fn contract_h265_config_extraction() {
        ...
        let _ = muxfin::codec::h265::extract_hevc_config(&hevc_data);
    ...
    fn contract_h265_keyframe_detection() {
        ...
        let _ = muxfin::codec::h265::is_hevc_keyframe(&hevc_data);
...
fn prop_cli_argument_parsing() {
    ...
    proptest!(ProptestConfig::with_cases(50), |(
        ...
        let output = Command::new("cargo")
            .args([
                "run", "--package", "muxfin-cli", "--bin", "muxfin", "--",
                "mux",
                "--video", video_fixture,
